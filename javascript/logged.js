$(function(){
  ...
  for(i = 0; i < doctor.length; i++){
    doctorsBody.append(
      ...
      '<br>Alternative Language: '+doctor[i]["alternativeLanguage"]+'<br>Available: '+doctor[i]["available"]+'</p></div></div></div></td><td><button class="btn btn-default">Book Now</button></td></tr>'
    );
  }
  ...
  for(i = 0; i < dentist.length; i++){
    dentistsBody.append(
      ...
      '<br>Alternative Language: '+dentist[i]["alternativeLanguage"]+'<br>Available: '+dentist[i]["available"]+'</p></div></div></div></td><td><button class="btn btn-default">Book Now</button></td></tr>'
    );
  }
  ...
  for(i = 0; i < optometrist.length; i++){
    optometristsBody.append(
      ...
      '<br>Alternative Language: '+optometrist[i]["alternativeLanguage"]+'<br>Available: '+optometrist[i]["available"]+'</p></div></div></div></td><td><button class="btn btn-default">Book Now</button></td></tr>'
    );
  }
});
